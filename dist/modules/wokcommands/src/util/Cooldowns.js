...
class Cooldowns {
    ...
    loadCooldowns() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield cooldown_schema_1.default.deleteMany({
                expires: { $lt: new Date() },
            });
            const results = yield cooldown_schema_1.default.find({});
    ...
    cancelCooldown(cooldownUsage) {
        return __awaiter(this, void 0, void 0, function* () {
            const key = this.getKeyFromCooldownUsage(cooldownUsage);
            this._cooldowns.delete(key);
            if (this._instance.isConnectedToDB) {
                yield cooldown_schema_1.default.deleteOne({ _id: key });
            }
        });
    }
    updateCooldown(cooldownUsage, expires) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (secondsDiff > this._dbRequired) {
                yield cooldown_schema_1.default.findOneAndUpdate({
                    _id: key,
                }, {
                    _id: key,
                    expires,

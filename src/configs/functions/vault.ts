 ...
 * @param password
 */
export function encryptAesGcm(plainText: string | object, password: string): string | undefined {
   try {
 ...
 * @param password
 */
export function decryptAesGcm(cipherText: string, password: string): string | undefined {
   try {
      const algorithm: CipherGCMTypes = getAlgorithm();

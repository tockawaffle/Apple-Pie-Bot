    ...
    run: async(client, messageCreate, args) => {
        ...
        try {
            const mainEmbed = new MessageEmbed()
                .setAuthor({name: user.username, url: author.displayAvatarURL({dynamic: true})})
                ...
                .setColor("RANDOM")
                .setFooter({text: lang(author, "can-be-used-on-dms"), iconURL: author.displayAvatarURL({dynamic: true})})
            ...
            const modEmbed = new MessageEmbed()
                ...
                .setFooter({text: lang(author, "can-not-be-used-on-dms"), iconURL: author.displayAvatarURL({dynamic: true})})
            ...
            const utilitiesEmbed = new MessageEmbed()
                ...
                .setFooter({text: lang(author, "some-can-be-used-on-dms"), iconURL: author.displayAvatarURL({dynamic: true})})
            ...
            const helpEncrypt = new MessageEmbed()
                ...
                .setColor("RANDOM")
                .setFooter({text: lang(author, "can-be-used-only-on-dms"), iconURL: author.displayAvatarURL({dynamic: true})})

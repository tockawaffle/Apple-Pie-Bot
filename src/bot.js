...
const
    ...
    { registerCommands, registerEvents, registerPlayerEvents, registerCommandNamesAndAliases } = require("./Utils/Registry/registry.js");

(async () => {
    client.login(process.env.TOKEN);
    client.commands = new Map();
    client.commandsNamesDescAndAliases = new Map();
    client.player = new Player(client);
    client.steam = new SteamAPI(process.env.STEAM_TOKEN);
    await registerEvents(client, "../../events/discordEvents");
    await registerCommands(client, "../../Commands");
    await registerCommandNamesAndAliases(client, "../../Commands");
